...
# Fresh customer set
customers = [
    {"name": "Radhika", "phone": "+916660000001"},
    {"name": "Gopal", "phone": "+916660000002"},
    {"name": "Nisha", "phone": "+916660000003"},
    {"name": "Rajesh", "phone": "+916660000004"},
    {"name": "Asha", "phone": "+916660000005"}
]
...
def run_simulation():
    print("Starting simulated customer traffic v4...")
    ...
    print("Finished sending simulated traffic v4.")
